# Specification: Servicios Transversales

## Overview
Define los servicios comunes de plataforma que protegen la integridad, trazabilidad y consistencia transaccional de FARMAXIA.
